...
Validator.isRequired = function (selector, message) {
  return {
    selector: selector,
    test: function (value) {
      return value.trim() ? undefined : message || 'Please enter a value'
    }
  };
}
...
const checkPhoneNumber = (phoneNumber) => {
  ...
  if((phoneNumber.length >=8 && phoneNumber.length <= 11) && (phoneNumber[0] === '0')) {
    return true
  }
  return false
...
Validator.isConfirmed = function (selector, getConfirmValue, message) {
  return {
    ...
    test: function (value) {
      ...
      return value === getConfirmValue() ? undefined : message || 'Inputed value is incorrect';
    }
  }
}
Validator.isPhoneNumber = function(selector, message) {
  return {
    ...
    selector : selector,
    test : function(value) {
      return checkPhoneNumber(value) ? undefined : message || 'Please enter a valid phone number'
    }
  }
}